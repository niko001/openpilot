...
procs = [
  ...
  NativeProcess("ui", "selfdrive/ui", ["./ui"], always_run, watchdog_max_dt=(5 if not PC else None), stderr="ui.stderr"),
  ...
  PythonProcess("wazed", "selfdrive.wazed.wazed", only_onroad),
