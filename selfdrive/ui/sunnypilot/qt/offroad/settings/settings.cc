...
SettingsWindowSP::SettingsWindowSP(QWidget *parent) : SettingsWindow(parent) {
  ...
  QList<PanelInfo> panels = {
    ...
    PanelInfo("   " + tr("User profiles"), new UserProfilesPanel(this), "../assets/icons/monitoring.png"),
    PanelInfo("   " + tr("infiniteCableCustom"), new InfiniteCableTogglesPanel(this), "../../sunnypilot/selfdrive/assets/offroad/icon_toggle.png"),
