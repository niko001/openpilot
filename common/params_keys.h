...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"WazeAlertsEnabled", {PERSISTENT, BOOL}},
    {"WazeAlertsHazards", {PERSISTENT, BOOL}},
    {"WazeAlertsJams", {PERSISTENT, BOOL}},
    {"WazeAlertsAccidents", {PERSISTENT, BOOL}},
    {"WazeAlertsPolice", {PERSISTENT, BOOL}},
    {"WazeAlertsRoadClosed", {PERSISTENT, BOOL}},
    {"WazeAlertsSpeedCameras", {PERSISTENT, BOOL}},
    {"WazeAlertsRedLightCameras", {PERSISTENT, BOOL}},
    {"WazeAlertsDistance", {PERSISTENT, INT}},
};
